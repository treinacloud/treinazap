...
function ChatFooter( { roomName, roomId, db, firebase, storage }) {
    ...
    const voiceMessage = () => {
        ...
        toastInfo("Mensagem de voz ainda não está disponível!", voiceMessageToastId, "top-center");
    };
    ...
    const onFileChange = async (e) => {
        ...
        if(file.size > 12 * 1024 * 1024){
            toastInfo("O arquivo não deve exceder mais de 12 MB", fileSizeToastId, "top-center"); 
        }else{
            ...
            :null} 
                ...
                <form>
                    <input 
                        ...
                        placeholder="Digite uma mensagem" type="text" 
                    />
                    <button 
                        onClick={sendMessage} 
                        type="submit">
