...
function Sidebar( { rooms, setIsRoomExist, isRoomExist }) {
    ...
    const archive = () => {
        ...
        toastInfo("Arquivo ainda não está disponível!", archive, "top-center");
    }

    const starred = () => {
        const starred = "starred";
        toastInfo("Starred ainda não está disponível!", starred, "top-center");
    }

    const settings = () => {
        const settings = "settings";
        toastInfo("Configurações ainda não estão disponíveis!", settings, "top-center");
    }
    ...
    return (
        <div className="sidebar">
            ...
            <SearchBar 
                search={search} 
                setSearch={setSearch} 
                placeholder="Pesquise ou inicie uma nova conversa" 
            />
